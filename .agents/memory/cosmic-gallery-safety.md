...
## Rule
Cosmic Ocean gallery searches default to strict safe-search behavior and must never dispatch adult-specific providers unless the query has explicit adult intent. Adult results are always presented with unknown licensing and source-verification attribution.
