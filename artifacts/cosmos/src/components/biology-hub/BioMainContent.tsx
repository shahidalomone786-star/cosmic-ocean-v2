  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <ArrowRight
          size={13}
          style={{ color: lm ? 'rgba(52,211,153,0.5)' : 'rgba(52,211,153,0.35)' }}
    ...
    <div className="flex items-baseline gap-3 mb-4">
      <h2
        ...
        style={{
          ...
          color: lm ? '#064e3b' : 'rgba(255,255,255,0.92)',
        }}
      >
        {title}
      </h2>
      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow: lm
            ...
            : '0 8px 32px rgba(52,211,153,0.06)',
        }}
      >
        {/* Ambient glow */}
        <div
        ...
        />
        <div
          className="absolute -bottom-6 left-10 w-32 h-32 rounded-full pointer-events-none"
        ...
        <div className="relative flex items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 mb-2">
              <span
                className="text-[9px] uppercase tracking-[0.25em] font-semibold px-2 py-0.5 rounded-full"
            ...
            <h1
              ...
              style={{
                fontFamily: 'var(--app-font-heading)',
                background: lm
                  ? 'linear-gradient(135deg, #065f46 0%, #0e7490 60%, #4338ca 100%)'
                  : 'linear-gradient(135deg, #34d399 0%, #06b6d4 60%, #a78bfa 100%)',
            ...
            <p
              className="text-[12px] leading-relaxed mb-4 max-w-sm"
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="flex-1 relative z-10">
          <p
            ...
            style={{ color: lm ? 'rgba(101,163,13,0.7)' : 'rgba(163,230,53,0.5)' }}
          >
            Featured Topic
          </p>
          <p
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px]" style={{ color: lm ? 'rgba(63,98,18,0.5)' : 'rgba(255,255,255,0.3)' }}>
              ~45 min deep dive
            </span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 gap-2.5">
        {topics.map((t, i) => (
          <PlaceholderCard
            key={t.title} lm={lm} title={t.title} subtitle={t.subtitle}
      ...
      <div className="grid grid-cols-1 gap-2.5">
        {organelles.map((org, i) => (
          <motion.div
            ...
            style={{
              ...glassCard(lm),
              boxShadow: lm ? '0 1px 10px rgba(52,211,153,0.04)' : '0 1px 10px rgba(0,0,0,0.2)',
            }}
          >
            <div className={`w-2.5 h-2.5 rounded-full flex-shrink-0 ${org.color}`} />
            <div className="flex-1 min-w-0">
              <p className="text-[12px] font-semibold" style={{ color: lm ? '#064e3b' : 'rgba(255,255,255,0.88)' }}>
                {org.name}
              </p>
