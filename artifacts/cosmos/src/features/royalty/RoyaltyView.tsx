...
function normalizeWallet(row: WalletRow): WalletBalance {
...
async function fetchOrCreateWallet(userId: string): Promise<WalletBalance> {
  ...
  // Creation is a narrowly-scoped database function, not a client insert:
  // users can never choose a starting balance or mint Royalty from the browser.
